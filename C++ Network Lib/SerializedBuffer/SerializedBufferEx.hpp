...
namespace SJNET
{
	namespace LIB
	{
		class SerializedBufferEx : public SerializedBuffer
		{
		public:
		...
		inline void SerializedBufferEx::szIn(_In_ const char* szData)
		{
		...
		inline void SerializedBufferEx::szIn(_In_ const std::string& data)
		{
			szIn(data.c_str());
		}
		...
		inline void SerializedBufferEx::szIn(_In_ const wchar_t* szData)
		{
		...
		inline void SerializedBufferEx::szIn(_In_ const std::wstring& data)
		{
			szIn(data.c_str());
		}
		...
		inline void SerializedBufferEx::szOut(_Inout_ char*& dest)
		{
		...
		inline void SerializedBufferEx::szOut(_Inout_ std::string& dest)
		{
			dest = reinterpret_cast<char*>(pointerSet.readPointer);
			pointerSet.readPointer = reinterpret_cast<char*>(pointerSet.readPointer) + strlen(reinterpret_cast<char*>(pointerSet.readPointer)) + 1;
		}

		inline void SerializedBufferEx::szOut(_Inout_ wchar_t*& dest)
		{
		...
		inline void SerializedBufferEx::szOut(_Inout_ std::wstring& dest)
		{
			dest = reinterpret_cast<wchar_t*>(pointerSet.readPointer);
			pointerSet.readPointer = reinterpret_cast<wchar_t*>(pointerSet.readPointer) + wcslen(reinterpret_cast<wchar_t*>(pointerSet.readPointer)) + 1;
		}
